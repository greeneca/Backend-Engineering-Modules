...
import (
	reflect "reflect"
	stores "wiki_updates/data/stores"
...
func (m *MockSessionInterface) Query(arg0 string, arg1 ...any) stores.QueryInterface {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(stores.QueryInterface)
	return ret0
}
...
func (m *MockQueryInterface) Bind(arg0 ...any) stores.QueryInterface {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
func (m *MockQueryInterface) Iter() stores.IterInterface {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Iter")
	ret0, _ := ret[0].(stores.IterInterface)
	return ret0
}
...
// Scan mocks base method.
func (m *MockIterInterface) Scan(arg0 ...any) bool {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
